                    ...
                    <div className="buttons">
                        {user ? (
                            <div className="dropdown">
                                <button className="btn btn-outline-light m-2 dropdown-toggle" type="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div className="dropdown-menu" aria-labelledby="userDropdown">
                                    ...
                                    <div className="dropdown-item">
                                        ...
                                        />
                                        <button className="btn btn-primary mt-2" onClick={handleSaveAddress}>Save Address</button>
                                    </div>
